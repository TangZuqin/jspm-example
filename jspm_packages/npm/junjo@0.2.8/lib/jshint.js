...
(function(Buffer, process) {
  var JSHINT = (function() {
    ...
    function isPoorRelation(node) {
      return node && ((node.type === '(number)' && +node.value === 0) || (node.type === '(string)' && node.value === '') || (node.type === 'null' && !option.boss) || node.type === 'true' || node.type === 'false' || node.type === 'undefined');
    }
    ...
    cssBorderStyle = ['none', 'dashed', 'dotted', 'double', 'groove', 'hidden', 'inset', 'outset', 'ridge', 'solid'];
    ...
    syntax['(identifier)'] = {
      ...
      nud: function() {
        ...
        if (funct === s) {
          ...
          if (anonname != 'typeof' && anonname != 'delete' && option.undef && typeof predefined[v] !== 'boolean') {
    ...
    infix('.', function(left, that) {
      ...
      that.left = left;
      that.right = m;
      if (option.noarg && left && left.value === 'arguments' && (m === 'callee' || m === 'caller')) {
    ...
    blockstmt('function', function() {
      if (inblock) {
        warning("Function statements should not be placed in blocks. Use a function expression or move the statement to the top of the outer function.", token);
      }
      var i = identifier();
      adjacent(token, nexttoken);
      addlabel(i, 'unction');
    ...
    var itself = function(s, o, g) {
      ...
      if (o) {
        ...
        if (o.safe) {
          ...
          o.eqeqeq = o.nomen = o.safe = o.undef = true;
