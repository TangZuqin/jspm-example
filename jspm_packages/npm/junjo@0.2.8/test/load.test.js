...
T.__proto__.total = function() {
  return this.success + '/' + this.count;
};
['equal', 'ok', 'fail', 'notEqual', 'deepEqual', 'notDeepEqual', 'strictEqual', 'notStrictEqual'].forEach(function(fname) {
